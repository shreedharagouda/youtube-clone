...
const Head = () => {
  ...
  useEffect(()=>{
    ...
    // function to make an api call for an every key press
    // but if the diffrence between 2 api calls <200ms
  ...
  return (
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      ...
      <div>
        ...
        {showSuggestions && (<div className="fixed bg-white py-2 px-2 w-[35rem] shadow-lg rounded-lg border-gray-100">
          <ul>
